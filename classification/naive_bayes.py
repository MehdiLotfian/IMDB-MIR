...
class NaiveBayes(BasicClassifier):
    ...
    def predict(self, x):
        ...
        max_class = self.classes[np.argmax(probs, axis=1)]
        return max_class
...
if __name__ == '__main__':
    ...
    """
    # Load data
    review_loader = ReviewLoader('../IMDB Dataset.csv')
    review_loader.load_data()
    reviews,  sentiments = review_loader.review_tokens, np.array(review_loader.sentiments)
