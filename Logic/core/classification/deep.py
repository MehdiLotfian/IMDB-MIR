...
class DeepModelClassifier(BasicClassifier):
    ...
    def prediction_report(self, x, y):
        ...
        """
        self.set_test_dataloader(x, y)
        loss, predicted_labels, true_labels, f1_macro = self._eval_epoch(self.test_loader, self.model)
...
if __name__ == '__main__':
    ...
    classifier = DeepModelClassifier(in_features=100, num_classes=2, batch_size=64, num_epochs=5)
