...
class BERTFinetuner:
    ...
    def preprocess_genre_distribution(self):
        ...
        def filter_genres(genres):
            return any(genre in top_genres for genre in genres)

        self.df = self.df[self.df['genres'].apply(filter_genres)]
    ...
    def split_dataset(self, test_size=0.3, val_size=0.5):
        ...
        self.train_df, self.val_df = train_test_split(train_val_df, test_size=val_size / (1 - test_size),
    ...
    def fine_tune_bert(self, epochs=5, batch_size=16, warmup_steps=500, weight_decay=0.01):
        ...
        self.model = BertForSequenceClassification.from_pretrained(
            'bert-base-uncased', num_labels=self.top_n_genres, from_tf=True)
