...
class Tiered_index:
    ...
    def convert_to_tiered_index(
        ...
        first_tier = {key: value for key, value in current_index.items() if value >= first_tier_threshold}
        second_tier = {key: value for key, value in current_index.items() if
                       first_tier_threshold > value >= second_tier_threshold}
        third_tier = {key: value for key, value in current_index.items() if value < second_tier_threshold}
