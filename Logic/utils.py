...
movies_dataset = json.load(open('/core/indexer/documents_index.json'))
...
def correct_text(text: str, all_documents: List[str]) -> str:
    ...
    """
    preprocessor = Preprocessor(list(text))
    text = preprocessor.preprocess()[0]
